...
const password= Joi.string().min(8).max(BCRYPT_MAX_BYTES, 'utf8').required() // bcrypt max is 72 bytes, char != bytes not always
/* 
...
.required() // bcrypt max is 72 bytes, char != bytes not always
*/
